...
namespace GeonBit.UI.Entities
{
    ...
    public class SelectList : Panel
    {
        ...
        public void AddItem(uint value, int index)
        {
        ...
        public void RemoveItem(uint value)
        {
            _list.Remove(value);
            OnListChanged();
        }
        ...
        protected void Select(uint value)
        {
        ...
        override protected void DrawEntity(SpriteBatch spriteBatch)
        {
            ...
            for (int i = 0; i < _paragraphs.Count; ++i)
            {
                ...
                if (item_index < _list.Count)
                {
                    ...
                    _paragraphs[i].Text = _list[item_index].ToString();
